                    ...
                    <div class="card padding-10">
                        ...
                        <div class="card-body backpack-profile-form bold-labels">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    @php
                                        $label = trans('backpack::base.avatar');
                                        $field = 'avatar';
                                    @endphp
                                    <label class="">{{ $label }}</label>
                                    <input   type="file" name="{{ $field }}"   onchange="preview(event)" >

                                    <img id="output" style="width: 200px; height: 200px; object-fit: cover" src="{{asset(backpack_auth()->user()->avatar)}}">
                                </div>
